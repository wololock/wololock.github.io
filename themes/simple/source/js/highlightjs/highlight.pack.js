...
name:"TypeScript",aliases:["ts"]}),g}}());hljs.registerLanguage("bash",function(){"use strict";return function(e){
...
},{className:"string",begin:/'/,end:/'/},s]}}}());hljs.registerLanguage("dockerfile",function(){"use strict";return function(e){
return{name:"Dockerfile",aliases:["docker"],case_insensitive:!0,
keywords:"from maintainer expose env arg user onbuild stopsignal",
contains:[e.HASH_COMMENT_MODE,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE,{
beginKeywords:"run cmd entrypoint volume add copy workdir label healthcheck shell",
starts:{end:/[^\\]$/,subLanguage:"bash"}}],illegal:"</"}}}());hljs.registerLanguage("go",function(){"use strict";return function(e){var n={
...
i.name="C++",i.aliases=["cc","c++","h++","hpp","hh","hxx","cxx"],i}}());hljs.registerLanguage("asciidoc",function(){"use strict";return function(e){
...
excludeBegin:!0,excludeEnd:!0,relevance:0}],relevance:10}]}}}());hljs.registerLanguage("markdown",function(){"use strict";return function(n){
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:a}}}());hljs.registerLanguage("shell",function(){"use strict";return function(s){return{
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},c,i]}}}());hljs.registerLanguage("groovy",function(){"use strict";function e(e,n={}){
...
excludeBegin:!0,end:t+":",relevance:0}],illegal:/#|<\//};var l}}());hljs.registerLanguage("scss",function(){"use strict";return function(e){
...
begin:t,end:a,contains:[n],relevance:5}])}}}());hljs.registerLanguage("gradle",function(){"use strict";return function(e){
