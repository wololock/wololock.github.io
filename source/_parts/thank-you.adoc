...
You can share it on icon:twitter[role="color-twitter"] pass:[{% share_post "twitter" %}], icon:linkedin-square[role="color-linkedin"] pass:[{% share_post "linkedin" %}], or anywhere else you find it useful.
