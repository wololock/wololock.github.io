...
:amazon-ca: https://amzn.to/2U2Fl1a
:amazon-fr: https://amzn.to/2MjuETL
:amazon-es: https://amzn.to/2ZZyEAF
...
image:/images/flags/us.png[] &nbsp; {amazon-us}["Get from amazon.com", role="ga-track"]

image:/images/flags/ca.png[] &nbsp; {amazon-ca}["Get from amazon.ca", role="ga-track"]

image:/images/flags/gb.png[] &nbsp; {amazon-uk}["Get from amazon.co.uk", role="ga-track"]

image:/images/flags/de.png[] &nbsp; {amazon-de}["Get from amazon.de", role="ga-track"]

image:/images/flags/fr.png[] &nbsp; {amazon-fr}["Get from amazon.fr", role="ga-track"]

image:/images/flags/es.png[] &nbsp; {amazon-es}["Get from amazon.es", role="ga-track"]
