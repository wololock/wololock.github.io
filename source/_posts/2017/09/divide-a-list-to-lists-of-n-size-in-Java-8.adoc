...
highlightjs: true
ad:
  name: "Udemy - Learn anything - Divide list"
...
<a href="https://click.linksynergy.com/deeplink?id=uow2LCEuhvQ&mid=39197&murl=https%3A%2F%2Fwww.udemy.com%2Fcourse%2Fjava-the-complete-java-developer-course%2F" class="gatr" data-type="banner" data-name="Java Programming Masterclass for Software Developers">
<img src="/images/yml/java-programming-masterclass-for-software-developers.jpg" class="img-fluid" alt="Java Programming Masterclass for Software Developers" />
</a>
</div>
++++
