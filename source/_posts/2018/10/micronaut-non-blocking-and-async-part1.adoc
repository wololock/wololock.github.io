...
NOTE: Continue reading here - https://e.printstacktrace.blog/2018/10/micronaut-non-blocking-and-async-part2/[Non-blocking and async Micronaut - quick start (part 2)]
