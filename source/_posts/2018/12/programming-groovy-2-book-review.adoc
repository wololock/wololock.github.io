...
card: /images/cards/programming-groovy.jpg
affiliates: true
book:
  title: "Programming Groovy 2: Dynamic Productivity for the Java Developer"
  description: "The strength of Java is no longer in the language itself; it's in the Java Platform (the JVM, JDK, and rich frameworks and libraries). But recently, the industry has turned to dynamic languages for increased productivity and speed to market. Groovy is one of a new breed of dynamic languages that run on the Java platform. You can use these new languages on the JVM and intermix them with your existing Java code. You can leverage your Java investments while benefiting from advanced features including true Closures, Meta Programming, the ability to create internal DSLs, and a higher level of abstraction."
  source:
    name: goodreads.com
    url: https://www.goodreads.com/book/show/22097079-programming-groovy-2
  image: "/images/books/programming-groovy-2.jpg"
  links:
    - flag: us
      text: Get from amazon.com
      url: https://www.amazon.com/gp/product/1937785300?ie=UTF8&tag=eprintstacktr-20&camp=1789&linkCode=xm2&creativeASIN=1937785300
    - flag: ca
      text: Get from amazon.ca
      url: https://amzn.to/2XRsBga
    - flag: de
      text: Get from amazon.de
      url: https://www.amazon.de/gp/product/1937785300?ie=UTF8&tag=eprintstac0c4-21&camp=1638&linkCode=xm2&creativeASIN=1937785300
    - flag: gb
      text: Get from amazon.co.uk
      url: https://www.amazon.co.uk/gp/product/1937785300?ie=UTF8&tag=eprintstack07-21&camp=1634&linkCode=xm2&creativeASIN=1937785300
    - flag: fr
      text: Get from amazon.fr
      url: https://amzn.to/3cRNGeB
    - flag: es
      text: Get from amazon.es
      url: https://amzn.to/2YqXabJ
---
